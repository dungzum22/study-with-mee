...
public class MessagesRepository {
	...
	private static final String UPDATE_SQL = "UPDATE Messages SET subject = ?, email = ?, updatedBy = ?  messages =? WHERE id = ?";
	...
	public MessagesModelResponse getByName(String name) {
		// Open connection and set SQL query into PreparedStatement.
		try (Connection connection = DBUtil.getConnection();
